...
const String kTemporaryPath = './test//mock_paths/Temp';
const String kApplicationSupportPath = './test/mock_paths/Support';
const String kDownloadsPath = './test/mock_paths/Downloads';
const String kLibraryPath = 'null';
const String kApplicationDocumentsPath = 'null';
const String kExternalCachePath = 'null';
const String kExternalStoragePath = 'null';
